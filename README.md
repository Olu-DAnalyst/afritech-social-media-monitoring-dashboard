...
- 📊 Power BI Dashboard  
  👉 [Download Power BI Dashboard](https://github.com/Olu-DAnalyst/afritech-social-media-monitoring-dashboard/raw/main/afritech_dashboard.pbix)
...
- 📁 Dataset (CSV)  
  👉 [Download Dataset](dataset/afritech_dataset.xls)
